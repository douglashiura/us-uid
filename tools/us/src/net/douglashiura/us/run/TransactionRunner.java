...
public class TransactionRunner {
	...
	private InteractionRunner target;
	private UUID uuid;

	public TransactionRunner(UUID uuid, InteractionRunner source, InteractionRunner target) {
		this.uuid = uuid;
		this.target = target;
	}

	public InteractionRunner getTarget() {
		return target;
	}
