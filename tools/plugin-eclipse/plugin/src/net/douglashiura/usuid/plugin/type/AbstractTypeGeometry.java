...
public abstract class AbstractTypeGeometry implements Rateable {
	...
	public AbstractTypeGeometry(LinkedTreeMap<String, ?> objectJson, UUID id, Geometry geometry, String model, String value) {
